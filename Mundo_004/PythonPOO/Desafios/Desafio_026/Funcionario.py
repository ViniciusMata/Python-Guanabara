...
class Funcionario(ABC):
    ...
    def analisar_salario(self):
        ...
        mensagem = f"O salário de [blue]{self.nome}[/] ([magenta]{type(self).__name__}[/]) é de [green]R${self.salario:.2f}[/] e corresponde a [yellow]{base:.1f} salários mínimos[/]."
        painel = Panel(mensagem, title="Análise Salarial", width=70)
        print(painel)
